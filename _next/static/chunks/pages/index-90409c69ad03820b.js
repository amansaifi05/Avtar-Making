      ...
      var e,
              ...
              (0, C.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, C.jsxs)("div", {
                    ...
                    children: [
                      "Your Peep is downloading and is free to use for personal or commercial projects. If the download doesn\u2019t happen automatically ",
                      (0, C.jsx)("button", {
                        onClick: g,
                        children: "click here",
                      }),
                  ...
                  (0, C.jsxs)("div", {
                    ...
                    children: [
                      (0, C.jsx)(S.Z, {
                        className: T().button,
                        title:
                          "Look what I just made with Peeps Avatar Maker from @ui8",
              ...
              children: [
                ...
                (0, C.jsxs)("div", {
                  ...
                  children: [
                    (0, C.jsx)("p", {
                      children:
                        "Peeps is an interactive 3D avatar builder brought to you by the UI8 team. This initial version of our builder is 100% free to use for personal and commercial projects.",
                    }),
                    (0, C.jsx)("p", {
                      children:
                        "You can use Peeps in your social profiles, social media posts, design projects, or anywhere you can use a friendly face. The only thing you cannot do, is resell or redistribute them.",
                    }),
                    (0, C.jsxs)("p", {
                      children: [
                        "To get started, customize your Peep by selecting different faces (expressions), headgear, eyewear, etc., giving you over ",
                        (0, C.jsx)("strong", {
                    ...
                    (0, C.jsx)("p", {
                      children:
                        "Once you\u2019re happy with your creation, clicking the download button will get you 2 files:",
                    }),
                  ],
                }),
                (0, C.jsxs)("ul", {
                  ...
                  children: [
                    (0, C.jsxs)("li", {
                      children: [
                        (0, C.jsx)(ac, {}),
                        " 1000x1000 PNG + Background",
                      ],
                    }),
                    (0, C.jsxs)("li", {
                      children: [
                        (0, C.jsx)(ac, {}),
                        " 1000x1000 PNG + Alpha (Transparent)",
                      ],
                    }),
                  ],
                }),
                ...
                children: Array.from(Array(g.length).keys()).map(function (a) {
                  return (0, C.jsx)(
                    "div",
                    {
                      className: J()(
                        ag().preview,
                        (0, I.Z)({}, ag().active, i[g.option] === a + 1)
                      ),
                      onClick: function () {
              ...
              return d().wrap(function (a) {
                for (;;)
                  switch ((a.prev = a.next)) {
                    case 0:
                      return (
                        (a.next = 2), au(b, "".concat(c, ".png"), "image/png")
                      );
                    case 2:
                      return (
                        (e = a.sent),
        ...
        aw = function (k) {
          ...
          var A,
                    ...
                    for (;;)
                      switch ((a.prev = a.next)) {
                        case 0:
                          L(),
                            I.render(J, z),
                            (e = I.domElement.toDataURL()),
                            as().saveAs(e, "peeps-avatar-alpha.png"),
                            M(),
                            L(),
                            I.setClearColor(b),
                            I.render(J, z),
                            (f = I.domElement.toDataURL()),
                            as().saveAs(f, "peeps-avatar.png"),
                            M(),
                            I.setClearColor(0, 0),
                            H(e),
                            av(e, c);
            ...
            j =
              1 === t
                ? n
                  ? "SKIN FACE BODY LIGHT"
                  : "SKIN FACE BODY DARK"
                : b("TATTOO".concat(n ? "LIGHT" : "DARK", "."), t - 1),
            D = (0, E.useRef)(null),
            x = (0, E.useState)(null),
            O = x[0],
            P = x[1];
          return (
            (0, ar.x)(function (b) {
              ...
              D.current &&
                (O
                  ? (a > O && a <= O + 0.45 && (D.current.rotation.y = a - O),
                    a > O + 0.45 &&
                      a <= O + 1.35 &&
                      (D.current.rotation.y = O + 0.9 - a),
                    a > O + 1.35 &&
                      a <= O + 1.8 &&
                      (D.current.rotation.y = a - (O + 1.8)))
                  : P(Math.ceil(a)));
            }),
            (0, C.jsxs)("mesh", {
              position: [0, -0.28, 0],
        ...
        aD = function (d, e, c) {
          ...
          a.execute(b, {
            ...
            at()
              .post("".concat("https://ui8.net", "/account/signin?json=1"), {
                email: d,
                password: e,
                next: "/",
                rcToken: a,
        ...
        aF = function (d, e, f, g, h, c) {
          ...
          a.execute(b, {
            ...
            at()
              .post("".concat("https://ui8.net", "/account/register?json=1"), {
                first_name: d,
                last_name: e,
                email: f,
                password: g,
                      ...
                      children: [
                        ...
                        (0, C.jsxs)("form", {
                          ...
                          onSubmit: function (a) {
                            a.preventDefault(),
                              v(!0),
                              aF(k, l, m, n, window.location.href, x);
                          },
                          children: [
                            (0, C.jsxs)("div", {
                              className: ay().row,
              ...
              (0, C.jsxs)(D(), {
                children: [
                  ...
                  (0, C.jsx)("meta", {
                    ...
                    content:
                      "Look what I just made with the Peeps Avatar Builder @UI8",
                  }),
                  (0, C.jsx)("meta", {
                    property: "og:image",
                    content: b,
